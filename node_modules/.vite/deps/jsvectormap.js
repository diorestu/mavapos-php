...
function setupZoomButtons() {
  ...
  var handler = function handler2(zoomin) {
    if (zoomin === void 0) {
      zoomin = true;
    }
    return function() {
...
var Line = (function(_BaseComponent) {
  ...
  _proto._draw = function _draw() {
    var _this$_options = this._options, index2 = _this$_options.index, group = _this$_options.group, map = _this$_options.map;
    var config = {
  ...
  _proto._getDAttribute = function _getDAttribute() {
    var _this$_options2 = this._options, x1 = _this$_options2.x1, y1 = _this$_options2.y1, x2 = _this$_options2.x2, y2 = _this$_options2.y2, curvature = _this$_options2.curvature;
...
var Marker = (function(_BaseComponent) {
  ...
  _proto._draw = function _draw() {
    var _this$_options = this._options, index2 = _this$_options.index, map = _this$_options.map, group = _this$_options.group, cx = _this$_options.cx, cy = _this$_options.cy;
  ...
  _proto._drawLabel = function _drawLabel() {
    var _this$_options2 = this._options, index2 = _this$_options2.index, map = _this$_options2.map, label = _this$_options2.label, labelsGroup = _this$_options2.labelsGroup, cx = _this$_options2.cx, cy = _this$_options2.cy, config = _this$_options2.config, isRecentlyCreated = _this$_options2.isRecentlyCreated;
    var labelText = this.getLabelText(index2, label);
    this._labelX = cx / map.scale - map.transX;
    this._labelY = cy / map.scale - map.transY;
    this._offsets = isRecentlyCreated && config.offsets ? config.offsets : this.getLabelOffsets(index2, label);
...
function repositionLines() {
  ...
  Object.values(this._lines).forEach(function(line) {
    ...
    if (startMarker && endMarker) {
      ...
      var _this$getMarkerPositi2 = _this.getMarkerPosition(endMarker.config), x2 = _this$getMarkerPositi2.x, y2 = _this$getMarkerPositi2.y;
