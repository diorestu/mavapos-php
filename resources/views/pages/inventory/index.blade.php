...
@section('content')
    <div x-data="inventoryManager(@js($items), @js($movements), @js($filters))" class="space-y-4">
        ...
        <section class="overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <form method="GET" action="{{ route('inventory') }}" class="flex flex-col gap-3 border-b border-gray-100 px-3 py-3 dark:border-gray-800 sm:flex-row sm:items-center sm:justify-between sm:px-4">
                <div class="relative w-full sm:max-w-[30%]">
                    ...
                    <input name="search" type="search" placeholder="Cari produk atau SKU"
