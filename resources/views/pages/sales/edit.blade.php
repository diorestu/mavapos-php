    ...
    <div class="mx-auto max-w-3xl space-y-4" x-data="saleEditor(@js($sale), @js($items))">
        ...
        <form @submit.prevent="submit" class="space-y-4 rounded-xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[.03]">
            ...
            <div class="grid gap-3 md:grid-cols-2">
                ...
                <label class="text-xs">Voucher pelanggan<select x-model="loyalty_reward" @change="discount = 0" class="mt-1 h-10 w-full rounded-lg border border-gray-300 bg-transparent px-3 text-sm dark:border-gray-700 dark:bg-gray-900"><option value="">Tidak menggunakan voucher</option><option value="fifty_percent">Diskon 50%</option><option value="free_cup">Gratis 1 cup</option></select></label>
            </div>
