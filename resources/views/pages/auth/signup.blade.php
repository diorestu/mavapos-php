                    ...
                    <div>
                        ...
                        <div class="relative py-3 sm:py-5">
                            ...
                            <div class="relative flex justify-center text-sm">
                                <span class="bg-white p-2 text-gray-400 sm:px-5 sm:py-2 dark:bg-gray-900">Atau</span>
                            </div>
                        </div>
                        <form method="POST" action="{{ route('signup.store') }}">
                            ...
                            <div class="space-y-5">
                                @if ($errors->any())
                                    <div class="rounded-lg border border-error-200 bg-error-50 px-4 py-3 text-sm text-error-600 dark:border-error-500/30 dark:bg-error-500/10 dark:text-error-400">
                                ...
                                <div>
                                    ...
                                    <div x-data="{ showPassword: false }" class="relative">
                                        <input id="password" name="password" :type="showPassword ? 'text' : 'password'" placeholder="Minimal 8 karakter"
                                ...
                                <!-- Checkbox -->
                                <div>
                                    <div x-data="{ checkboxToggle: {{ old('terms') ? 'true' : 'false' }} }">
                                        <label for="checkboxLabelOne"
                                            class="flex cursor-pointer items-start text-sm font-normal text-gray-700 select-none dark:text-gray-400">
                                            <div class="relative">
                                                <input type="checkbox" id="checkboxLabelOne" name="terms" value="1" class="sr-only" @change="checkboxToggle = !checkboxToggle" @checked(old('terms')) />
                                            ...
                                            <p class="inline-block font-normal text-gray-500 dark:text-gray-400">
                                                ...
                                                <a href="{{ route('terms-of-service') }}" target="_blank" rel="noopener" class="text-gray-800 underline-offset-4 hover:text-brand-500 hover:underline dark:text-white/90">
                                                    Syarat dan Ketentuan,
                                                </a>
                                                serta
                                                <a href="{{ route('privacy-policy') }}" target="_blank" rel="noopener" class="text-gray-800 underline-offset-4 hover:text-brand-500 hover:underline dark:text-white">
                                                    Kebijakan Privasi
                                                </a>
                                            </p>
                                        </label>
                        ...
                        <div class="mt-5">
                            <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
                                Sudah punya akun?
                                <a href="{{ route('signin') }}" class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Masuk</a>
                            </p>
                        </div>
                    </div>
                </div>
