...
<div class="relative" x-data="{
    ...
    >
        <!-- User Info -->
        <div>
            <span class="block font-medium text-gray-700 text-theme-sm dark:text-gray-400">{{ $currentUser?->name ?? 'Pengguna' }}</span>
            <span class="mt-0.5 block text-theme-xs text-gray-500 dark:text-gray-400">{{ $currentUser?->email ?? 'email belum tersedia' }}</span>
        </div>
